...
import com.mygdx.game.DemoGame.ControlStage;
...
public class GameScreen extends MyScreen {
    com.mygdx.game.Game.GameStage box2dStage;
    ...
    public void init() {
        super.init();
        box2dStage = new com.mygdx.game.Game.GameStage(new ExtendViewport(16,9,new OrthographicCamera(16,9)),spriteBatch,game);
